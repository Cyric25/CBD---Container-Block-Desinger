                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="cbd-icon-picker">
                                        ...
                                        $cbd_icon_position     = cbd_sanitize_icon_position($features['icon']['position'] ?? '');
                                        $cbd_icon_offset_x     = cbd_sanitize_icon_offset($features['icon']['offsetX'] ?? 0);
                                        $cbd_icon_offset_y     = cbd_sanitize_icon_offset($features['icon']['offsetY'] ?? 0);
...
<!-- Formular-CSS ausgelagert nach assets/css/edit-block-form.css -->
