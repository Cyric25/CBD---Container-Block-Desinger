...
class CBD_Consolidated_Frontend {
    ...
    private function generate_container_html($styles, $features, $config, $content, $block_slug, $block_data = null, $attributes = array()) {
        ...
        $html .= $this->process_html_content($content);
     ...
     */
    private function process_html_content($content) {
        if (empty($content)) {
            return $content;
        }
        ...
        $processed_content .= $this->get_html_initialization_script();
     ...
     */
    private function get_html_initialization_script() {
